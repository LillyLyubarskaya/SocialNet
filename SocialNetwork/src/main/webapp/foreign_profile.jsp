...
<body>
	...
	<div class="sidebar">
		<ul class="list-group">
			...
			<li class="list-group-item"><span class="glyphicon glyphicon-pushpin"></span><a href="edit_profile.jsp" class="profile_link">Edit profile</a></li>
  			<li class="list-group-item"><span class="glyphicon glyphicon-pencil"></span><a href="/dialogServlet?id=<%=currentUser.getId()%>" class="profile_link">Messages</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<img class="photo" src="/imageServlet?id=<%=user.getId()%>">
				<div class="panel panel-default">
  					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span><a href="/messageServlet?id=<%=user.getId()%>" class="profile_link">Write a message</a></div>
				</div>

				<div class="panel panel-default">
  					<div class="panel-heading"><%=ui.getName()%>  <%=ui.getSurname()%></div>
  					<div class="panel-heading"><%=ul.countAge(user)%></div>
  					<div class="panel-heading"><%=ui.getPosition()%></div>
				</div>
			</div>
		</div>
	</div>
